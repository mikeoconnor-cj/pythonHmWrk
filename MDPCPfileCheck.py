...
all_paths = [
    ...
    "D:\\Users\\michael.oconnor\\q3\\attribReports"
    # "D:\\Users\\michael.oconnor\\q2\\allClaimsUnzipped"
]
export_info = {}
...
# UPDATE OUTPUT PATH
writer = pd.ExcelWriter("D:\\Users\\michael.oconnor\\file_name_checksClaims{}.xlsx".format(date), engine='xlsxwriter') # pylint: disable=abstract-class-instantiated
